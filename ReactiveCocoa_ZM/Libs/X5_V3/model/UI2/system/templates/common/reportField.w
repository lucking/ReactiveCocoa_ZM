    ...
    <div component="$UI/system/components/justep/row/row" class="x-row"> 
      ...
      <div class="x-col x-col-20 x-col-center"> 
        <a class="btn btn-default" component="$UI/system/components/justep/button/button"
          onClick="addAll" style="width:46px;display:block;">&gt;&gt;</a>  
         
        <a class="btn btn-default" component="$UI/system/components/justep/button/button"
          onClick="add" style="width:46px;display:block">&gt;</a>  
          
        <a class="btn btn-default" component="$UI/system/components/justep/button/button"
          onClick="del" style="width:46px;display:block">&lt;</a>  
          
        <a class="btn btn-default" component="$UI/system/components/justep/button/button"
          onClick="delAll" style="width:46px;display:block">&lt;&lt;</a> 
      </div>  
      <div class="x-col"> 
        <div component="$UI/system/components/designerCommon/grid/grid" xid="grid"
