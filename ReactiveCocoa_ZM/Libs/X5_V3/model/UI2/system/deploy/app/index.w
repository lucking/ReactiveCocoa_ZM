...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" xid="window" class="window"
  ...
  <div xid="containerParent" style="padding:54px 8px 54px 8px;margin:0px 0px 0px 0px;overflow:hidden;"/>  
  <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation"> 
    <div class="navbar-buttons-container"> 
      <span style="display:inline-block;width:80px;" xid="span1"><![CDATA[应用名：]]></span>  
      <input component="$UI/system/components/justep/input/input" class="form-control"
        style="width:240px;display:inline" xid="appName"/>  
