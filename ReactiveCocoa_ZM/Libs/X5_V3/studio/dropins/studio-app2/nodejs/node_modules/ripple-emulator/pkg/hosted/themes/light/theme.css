...
.ui-state-default a, .ui-state-default a:link, .ui-state-default a:visited { color: #555555; text-decoration: underline; }
...
/* Overlays */
.ui-widget-overlay { background: #CCCCCC url(images/ui-bg_flat_0_aaaaaa_40x100.png) 50% 50% repeat-x; opacity: .30;filter:Alpha(Opacity=30); }
...
/*text
---------------*/
.ui-text-label { font-weight: bold;  color: #3C8B9E;}
...
.logo {
    background-image: url("../../images/ripplelogo.png");
}
