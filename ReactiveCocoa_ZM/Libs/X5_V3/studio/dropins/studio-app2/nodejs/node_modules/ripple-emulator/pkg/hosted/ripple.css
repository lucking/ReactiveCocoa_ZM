...
.prefix-with-right-arrow:before {
    content: '\25BA';
    padding-right: 3px;
}
...
.platform-select-dialog {
    ...
    .platform-select-buttons button {
...
#contextMenu {
    height: 100%;
    width: 613px;
    border-image: url('images/webworks/bb10/core_crosscutmenu_bg.png') 1 1 1 15 fill / 0 0 0 0 repeat;
    -webkit-box-shadow: -10px 0 25px #121212;
    box-shadow: -10px 0 25px #121212;
...
.hideContextMenuHandle {
    display: none;
}

.hideContextMenuDelete {
...
.showContextMenuHandle {
    ...
    height: 119px;
    width: 121px;
    background-image: url('images/webworks/bb10/drag_bar.png');
}
...
.showContextmenuItem {
    -webkit-transform: translateZ(0) translate(-462px,0);
    transform: translateZ(0) translate(-462px,0);
    border-image: url('images/webworks/bb10/core_crosscutmenu_selected.png') 2 1 2 13 / 1 1 1 1;
    z-index:101;
}
