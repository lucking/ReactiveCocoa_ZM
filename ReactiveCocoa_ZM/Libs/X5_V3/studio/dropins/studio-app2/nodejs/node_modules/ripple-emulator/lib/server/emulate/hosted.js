...
function proxyRemote(opts, req, res) {
    var proxyReqData,
        ...
        shouldInjectInto = req.path.match(/^\/$/) || req.path.match(/\.html/)|| req.path.match(/\.w/);//zmh 支持.w
	opts.userAgent = "Mozilla/5.0 (Linux; U; Android 4.3; en-us; SM-N900T Build/JSS15J) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30";//zmh 
